...
# datasetROOT = '/media/smallflyfly/Data/yolov3/Dataset/car/Images/'
...
datatxt = open(dataTXT, 'wt')
count = 0
for imgfile in imgFils:
    allfilename = './Dataset/Car/images/' + imgfile
    filename = imgfile[:-4]
    ...
    # car = '0' #person / car class index 0
    # for line in lines:
